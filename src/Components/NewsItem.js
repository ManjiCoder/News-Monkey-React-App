    ...
    <div className="max-w-screen-sm 2xl:max-w-md  bg-white rounded-lg border border-gray-200 shadow-md dark:shadow-gray-800 dark:bg-gray-900 dark:border-gray-700 flex flex-col">
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <button
              className="w-28 inline-flex pt-2.5 items-center justify-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              type="button"
            >
              Share <MdShare className="ml-3 mb-0.5" />
            </button>
          </RWebShare>
        </div>
      </div>
