...
function Footer(props) {
  return (
    <footer className="mt-auto">
      <hr className="border-gray-200 sm:mx-auto dark:border-white" />
      <div className="p-4 bg-slate-200 sm:p-6 dark:bg-gray-900">
              ...
              <ul className="text-gray-600 dark:text-gray-400 space-y-4">
                <li>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://github.com/ManjiCoder/News-Monkey-React-App"
                    className="hover:underline "
                  >
                    Github
                  </a>
